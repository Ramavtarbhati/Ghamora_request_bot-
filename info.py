...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Ramavtar:<password>@cluster0.9storls.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Ghamora_request_bot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Channel Button Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/allmoviereq786')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/hindimovieall12')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', PapaSupport')
...
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001644413057))
